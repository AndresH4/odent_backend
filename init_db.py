...
def create_database_and_tables():
    ...
    CREATE TABLE afiliacion (
      ...
      FOREIGN KEY (TipoEPS_ID) REFERENCES tipo_eps(TipoEPS_ID)
    );
    ...
    ('Endodoncia'), ('Odontopediatria'), ('Odontologia General'), ('Cirugia Oral'), ('Ortodoncia'), ('Control brackets');

    INSERT INTO regimen_eps (Descripcion) VALUES ('Contributivo'), ('Subsidiado');
    INSERT INTO tipo_eps (Nombre_Tipo) VALUES ('Cotizante'), ('Beneficiario');
    ...
    (1, 1, 1, '2025-05-15'), (2, 7, 1, '2023-08-06'), (3, 6, 1, '2025-09-09'), (4, 2, 1, '2021-02-28'),
    (5, 2, 1, '2023-07-21'), (6, 1, 1, '2022-09-22'), (7, 4, 1, '2026-01-31'), (8, 2, 1, '2026-02-12'),
    (9, 3, 1, '2023-05-18'), (10, 5, 1, '2025-03-12'), (11, 4, 1, '2025-05-21'), (12, 6, 1, '2016-08-14'),
    (13, 1, 1, '2015-06-15'), (14, 2, 1, '2016-04-12'), (15, 7, 1, '2025-02-15'), (16, 3, 1, '2017-06-30'),
    (17, 4, 1, '2023-07-21'), (18, 5, 1, '2022-09-22'), (19, 1, 1, '2026-01-31'), (20, 1, 1, '2026-02-12'),
    (21, 4, 1, '2023-05-18'), (22, 6, 1, '2025-03-12'), (23, 2, 1, '2025-05-21'), (24, 7, 1, '2016-08-14'),
    ...
    (4, 1, '2025-10-25', 'Datos asegurados'), (5, 1, '2025-10-26', 'Datos asegurados'), (6, 1, '2025-10-27', 'Datos asegurados'),
    (7, 1, '2025-10-28', 'Datos asegurados'), (8, 1, '2025-10-29', 'Datos asegurados'), (9, 1, '2025-10-30', 'Datos asegurados'),
    (10, 1, '2025-10-31', 'Datos asegurados'), (11, 1, '2025-11-01', 'Datos asegurados'), (12, 1, '2025-11-02', 'Datos asegurados'),
    (13, 1, '2025-11-03', 'Datos asegurados'), (14, 1, '2025-11-04', 'Datos asegurados'), (15, 1, '2025-11-05', 'Datos asegurados'),
    (16, 1, '2025-11-06', 'Datos asegurados'), (17, 1, '2025-11-07', 'Datos asegurados'), (18, 1, '2025-11-08', 'Datos asegurados'),
    (19, 1, '2025-11-09', 'Datos asegurados'), (20, 1, '2025-11-10', 'Datos asegurados'), (21, 1, '2025-11-11', 'Datos asegurados'),
    (22, 1, '2025-11-12', 'Datos asegurados'), (25, 1, '2025-11-13', 'Datos asegurados'), (26, 1, '2025-11-14', 'Datos asegurados'),
    (28, 1, '2025-11-15', 'Datos asegurados'), (29, 1, '2025-11-16', 'Datos asegurados'), (30, 1, '2025-11-17', 'Datos asegurados'),
    (31, 1, '2025-11-18', 'Datos asegurados');
    ...
    (1, 'Profilaxis y aplicación de fluor'), (2, 'Resina simple en pieza 36'), (3, 'Endodoncia Multirradicular'),
    (4, 'Exodoncia de cordales (3.8,4.8)'), (5, 'Blanqueamiento dental LED'), (6, 'Colocación de Brakets'),
    (7, 'Corona de porcelana sobre implante'), (8, 'Raspaje y alisado radicular'), (9, 'Pulpotomia pediatrica'),
    (10, 'Instalación de protesis parcial');
    """
